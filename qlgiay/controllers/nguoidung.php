<?php
	...
	class NguoiDungController
	{
		...
		public function getSua($id)
		{
			...
			public function getDMK($id)
		{
			$db = new NguoiDungDB();
			$nguoidung = $db->ChiTiet($id);
			include_once "views/nguoidung/doimatkhau.php";
		}
			public function postDMK($request)
		{
			$db = new NguoiDungDB();
			$db->DMK($request);
		...
		public function getAD($id)
		{
			$db = new NguoiDungDB();
			$nguoidung = $db->ChiTiet($id);
			include_once "views/nguoidung/admindoimk.php";
		}
		public function postAD($request)
		{
			$db = new NguoiDungDB();
			$db->ADMINDOIMK($request);
			header("Location: index.php?action=nguoidung");
		}
